...
<input type="checkbox" <?php if(isset($record->hotproduct)&&$record->hotproduct==1): ?> checked <?php endif; ?> name="hotproduct" id="hotproduct"> <label for="hotproduct">Hot product</label>
            ...
            <div class="row" style="margin-top:5px;">
                <div class="col-md-2"></div>
                <div class="col-md-10">
                    <?php if(isset($record->img)&&$record->img!=""&&file_exists("Assets/Fronted/images/news/".$record->img)): ?>
                    <img src="Assets/Fronted/images/news/<?php echo $record->img; ?>" style="width: 100px;">
                    <?php endif; ?>
                </div>
            </div>
            <!-- end rows -->
